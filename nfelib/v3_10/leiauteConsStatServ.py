...
#
# Generated Tue Mar 20 01:42:22 2018 by generateDS.py version 2.29.2.
...
class TConsStatServ(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TConsStatServ', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TConsStatServ', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            ...
            # validate type TVerConsStatServ
            self.validate_TVerConsStatServ(self.versao)
...
class TRetConsStatServ(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TRetConsStatServ', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TRetConsStatServ', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TRetConsStatServ', fromsubclass_=False, pretty_print=True):
        ...
        if self.tMed is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tMed>%s</tMed>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.tMed), input_name='tMed')), eol_))
        if self.dhRetorno is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhRetorno>%s</dhRetorno>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.dhRetorno), input_name='dhRetorno')), eol_))
        if self.xObs is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<xObs>%s</xObs>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.xObs), input_name='xObs')), eol_))
