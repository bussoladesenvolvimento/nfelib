...
#
# Generated Tue Mar 20 01:42:16 2018 by generateDS.py version 2.29.2.
...
class TConsSitNFe(GeneratedsSuper):
    ...
    def validate_TAmb(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TAmb' % {
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on xServType' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_TChNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 44:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TChNFe' % {
                               "value": value.encode("utf-8")})
            if not self.gds_validate_simple_patterns(
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TVerConsSitNFe' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='TConsSitNFe', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TConsSitNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TConsSitNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TConsSitNFe', fromsubclass_=False, pretty_print=True):
        ...
        if self.tpAmb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpAmb>%s</tpAmb>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.tpAmb), input_name='tpAmb')), eol_))
        if self.xServ is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<xServ>%s</xServ>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.xServ), input_name='xServ')), eol_))
        if self.chNFe is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<chNFe>%s</chNFe>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.chNFe), input_name='chNFe')), eol_))
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            # validate type TVerConsSitNFe
            self.validate_TVerConsSitNFe(self.versao)
...
class TRetConsSitNFe(GeneratedsSuper):
    ...
    def insert_procEventoNFe_at(
        self, index, value): self.procEventoNFe.insert(index, value)
    ...
    def validate_TVerAplic(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TVerAplic' % {
                               "value": value})
            if len(str(value)) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on TVerAplic' % {
                               "value": value})
            if not self.gds_validate_simple_patterns(
    ...
    def validate_TStat(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 3:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TStat' % {
                               "value": value.encode("utf-8")})
            if not self.gds_validate_simple_patterns(
    ...
    def validate_TMotivo(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TMotivo' % {
                               "value": value})
            if len(str(value)) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on TMotivo' % {
                               "value": value})
            if not self.gds_validate_simple_patterns(
    ...
    def validate_TCodUfIBGE(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['11', '12', '13', '14', '15', '16', '17', '21', '22', '23', '24', '25',
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TCodUfIBGE' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='TRetConsSitNFe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TRetConsSitNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TRetConsSitNFe', fromsubclass_=False, pretty_print=True):
        ...
        if self.verAplic is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<verAplic>%s</verAplic>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.verAplic), input_name='verAplic')), eol_))
        if self.cStat is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cStat>%s</cStat>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.cStat), input_name='cStat')), eol_))
        if self.xMotivo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<xMotivo>%s</xMotivo>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.xMotivo), input_name='xMotivo')), eol_))
        if self.cUF is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cUF>%s</cUF>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.cUF), input_name='cUF')), eol_))
        if self.dhRecbto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhRecbto>%s</dhRecbto>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.dhRecbto), input_name='dhRecbto')), eol_))
        if self.chNFe is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<chNFe>%s</chNFe>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.chNFe), input_name='chNFe')), eol_))
        if self.protNFe is not None:
            self.protNFe.export(outfile, level, namespace_,
                                name_='protNFe', pretty_print=pretty_print)
        if self.retCancNFe is not None:
            self.retCancNFe.export(
                outfile, level, namespace_, name_='retCancNFe', pretty_print=pretty_print)
        for procEventoNFe_ in self.procEventoNFe:
            procEventoNFe_.export(outfile, level, namespace_,
                                  name_='procEventoNFe', pretty_print=pretty_print)
...
class TProtNFe(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TProtNFe', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TProtNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TProtNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TProtNFe', fromsubclass_=False, pretty_print=True):
        ...
        if self.infProt is not None:
            self.infProt.export(outfile, level, namespace_,
                                name_='infProt', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='ds:', name_='Signature', pretty_print=pretty_print)
...
class TRetCancNFe(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TRetCancNFe', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TRetCancNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TRetCancNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TRetCancNFe', fromsubclass_=False, pretty_print=True):
        ...
        if self.infCanc is not None:
            self.infCanc.export(outfile, level, namespace_,
                                name_='infCanc', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='ds:', name_='Signature', pretty_print=pretty_print)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            # validate type TVerCancNFe
            self.validate_TVerCancNFe(self.versao)
...
class TEvento(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TEvento', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TEvento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TEvento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TEvento', fromsubclass_=False, pretty_print=True):
        ...
        if self.infEvento is not None:
            self.infEvento.export(outfile, level, namespace_,
                                  name_='infEvento', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='ds:', name_='Signature', pretty_print=pretty_print)
...
class TRetEvento(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TRetEvento', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TRetEvento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TRetEvento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            # validate type TRetVerEvento
            self.validate_TRetVerEvento(self.versao)
...
class TProcEvento(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TProcEvento', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TProcEvento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TProcEvento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TProcEvento', fromsubclass_=False, pretty_print=True):
        ...
        if self.evento is not None:
            self.evento.export(outfile, level, namespace_,
                               name_='evento', pretty_print=pretty_print)
        if self.retEvento is not None:
            self.retEvento.export(outfile, level, namespace_,
                                  name_='retEvento', pretty_print=pretty_print)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SignatureType', fromsubclass_=False, pretty_print=True):
        ...
        if self.SignedInfo is not None:
            self.SignedInfo.export(
                outfile, level, namespace_, name_='SignedInfo', pretty_print=pretty_print)
        if self.SignatureValue is not None:
            self.SignatureValue.export(
                outfile, level, namespace_, name_='SignatureValue', pretty_print=pretty_print)
        if self.KeyInfo is not None:
            self.KeyInfo.export(outfile, level, namespace_,
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SignedInfoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.CanonicalizationMethod is not None:
            self.CanonicalizationMethod.export(
                outfile, level, namespace_, name_='CanonicalizationMethod', pretty_print=pretty_print)
        if self.SignatureMethod is not None:
            self.SignatureMethod.export(
                outfile, level, namespace_, name_='SignatureMethod', pretty_print=pretty_print)
        if self.Reference is not None:
            self.Reference.export(outfile, level, namespace_,
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ReferenceType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Transforms is not None:
            self.Transforms.export(
                outfile, level, namespace_, name_='Transforms', pretty_print=pretty_print)
        if self.DigestMethod is not None:
            self.DigestMethod.export(
                outfile, level, namespace_, name_='DigestMethod', pretty_print=pretty_print)
        if self.DigestValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DigestValue>%s</DigestValue>%s' %
...
class TransformsType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TransformsType', fromsubclass_=False, pretty_print=True):
        ...
        for Transform_ in self.Transform:
            Transform_.export(outfile, level, namespace_,
...
class KeyInfoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='KeyInfoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.X509Data is not None:
            self.X509Data.export(outfile, level, namespace_,
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='X509DataType', fromsubclass_=False, pretty_print=True):
        ...
        if self.X509Certificate is not None:
            ...
            outfile.write('<X509Certificate>%s</X509Certificate>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.X509Certificate), input_name='X509Certificate')), eol_))
...
class infProtType(GeneratedsSuper):
    ...
    def validate_TProt(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TProt' % {
                               "value": value.encode("utf-8")})
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespace_='', name_='infProtType', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='infProtType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='infProtType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='infProtType', fromsubclass_=False, pretty_print=True):
        ...
        if self.dhRecbto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhRecbto>%s</dhRecbto>%s' %
                          (self.gds_format_datetime(self.dhRecbto, input_name='dhRecbto'), eol_))
        if self.nProt is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nProt>%s</nProt>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.nProt), input_name='nProt')), eol_))
        if self.digVal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<digVal>%s</digVal>%s' %
                          (self.gds_format_base64(self.digVal, input_name='digVal'), eol_))
        if self.cStat is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cStat>%s</cStat>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.cStat), input_name='cStat')), eol_))
...
class infCancType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='infCancType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='infCancType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='infCancType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class infEventoType(GeneratedsSuper):
    ...
    def validate_TCOrgaoIBGE(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['11', '12', '13', '14', '15', '16', '17', '21', '22', '23', '24', '25', '26', '27',
                            '28', '29', '31', '32', '33', '35', '41', '42', '43', '50', '51', '52', '53', '90', '91', '92']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    enumeration_respectee = True
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TCOrgaoIBGE' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_TCnpjOpc(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TCnpjOpc' % {
                               "value": value.encode("utf-8")})
            if not self.gds_validate_simple_patterns(
    ...
    def validate_TCpf(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 11:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TCpf' % {
                               "value": value.encode("utf-8")})
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespace_='', name_='infEventoType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='infEventoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='infEventoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.cOrgao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cOrgao>%s</cOrgao>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.cOrgao), input_name='cOrgao')), eol_))
        if self.tpAmb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpAmb>%s</tpAmb>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.tpAmb), input_name='tpAmb')), eol_))
        ...
        if self.dhEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhEvento>%s</dhEvento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.dhEvento), input_name='dhEvento')), eol_))
        if self.tpEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpEvento>%s</tpEvento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.tpEvento), input_name='tpEvento')), eol_))
        if self.nSeqEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nSeqEvento>%s</nSeqEvento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.nSeqEvento), input_name='nSeqEvento')), eol_))
        if self.verEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<verEvento>%s</verEvento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.verEvento), input_name='verEvento')), eol_))
        if self.detEvento is not None:
            self.detEvento.export(outfile, level, namespace_,
                                  name_='detEvento', pretty_print=pretty_print)
...
class detEventoType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='detEventoType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='detEventoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class infEventoType1(GeneratedsSuper):
    ...
    def validate_xEventoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 60:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on xEventoType' % {
                               "value": value})
            if len(str(value)) < 5:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on xEventoType' % {
                               "value": value})
            if not self.gds_validate_simple_patterns(
    ...
    def validate_emailDestType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 60:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on emailDestType' % {
                               "value": value})
            if len(str(value)) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on emailDestType' % {
                               "value": value})
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespace_='', name_='infEventoType1', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='infEventoType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='infEventoType1', fromsubclass_=False, pretty_print=True):
        ...
        if self.xEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<xEvento>%s</xEvento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.xEvento), input_name='xEvento')), eol_))
        if self.nSeqEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nSeqEvento>%s</nSeqEvento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.nSeqEvento), input_name='nSeqEvento')), eol_))
        if self.CNPJDest is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CNPJDest>%s</CNPJDest>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CNPJDest), input_name='CNPJDest')), eol_))
        if self.CPFDest is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CPFDest>%s</CPFDest>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CPFDest), input_name='CPFDest')), eol_))
        if self.emailDest is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<emailDest>%s</emailDest>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.emailDest), input_name='emailDest')), eol_))
        if self.dhRegEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhRegEvento>%s</dhRegEvento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.dhRegEvento), input_name='dhRegEvento')), eol_))
        if self.nProt is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nProt>%s</nProt>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.nProt), input_name='nProt')), eol_))
