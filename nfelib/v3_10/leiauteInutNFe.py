...
#
# Generated Tue Mar 20 01:42:24 2018 by generateDS.py version 2.29.2.
...
class TInutNFe(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TInutNFe', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TInutNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TInutNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TInutNFe'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TInutNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.infInut is not None:
            self.infInut.export(outfile, level, namespace_,
                                name_='infInut', pretty_print=pretty_print)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            ...
            # validate type TVerInutNFe
            self.validate_TVerInutNFe(self.versao)
...
class TRetInutNFe(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TRetInutNFe', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='TRetInutNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TRetInutNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TRetInutNFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='', name_='TRetInutNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TProcInutNFe(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TProcInutNFe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TProcInutNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TProcInutNFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='', name_='TProcInutNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.inutNFe is not None:
            self.inutNFe.export(outfile, level, namespace_,
                                name_='inutNFe', pretty_print=pretty_print)
        if self.retInutNFe is not None:
            self.retInutNFe.export(
                outfile, level, namespace_, name_='retInutNFe', pretty_print=pretty_print)
...
class infInutType(GeneratedsSuper):
    ...
    def __init__(self, Id=None, tpAmb=None, xServ=None, cUF=None, ano=None, CNPJ=None, mod=None, serie=None, nNFIni=None, nNFFin=None, xJust=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.tpAmb = tpAmb
    ...
    def validate_TCnpj(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TCnpj' % {
                               "value": value.encode("utf-8")})
            if not self.gds_validate_simple_patterns(
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TMod' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_TJust(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on TJust' % {
                               "value": value})
            if len(str(value)) < 15:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on TJust' % {
                               "value": value})
            if not self.gds_validate_simple_patterns(
    ...
    def export(self, outfile, level, namespace_='', name_='infInutType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='infInutType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='infInutType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='infInutType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))

    def exportChildren(self, outfile, level, namespace_='', name_='infInutType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ano is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ano>%s</ano>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.ano), input_name='ano')), eol_))
        ...
        if self.mod is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<mod>%s</mod>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.mod), input_name='mod')), eol_))
        ...
        if self.nNFIni is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nNFIni>%s</nNFIni>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.nNFIni), input_name='nNFIni')), eol_))
        if self.nNFFin is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nNFFin>%s</nNFFin>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.nNFFin), input_name='nNFFin')), eol_))
        if self.xJust is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<xJust>%s</xJust>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.xJust), input_name='xJust')), eol_))
...
class infInutType1(GeneratedsSuper):
    ...
    def __init__(self, Id=None, tpAmb=None, verAplic=None, cStat=None, xMotivo=None, cUF=None, ano=None, CNPJ=None, mod=None, serie=None, nNFIni=None, nNFFin=None, dhRecbto=None, nProt=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.tpAmb = tpAmb
        self.validate_TAmb(self.tpAmb)
    ...
    def export(self, outfile, level, namespace_='', name_='infInutType1', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='infInutType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='infInutType1'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))

    def exportChildren(self, outfile, level, namespace_='', name_='infInutType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
