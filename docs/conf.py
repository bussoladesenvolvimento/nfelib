# -*- coding: utf-8 -*-
#
# nfelib documentation build configuration file, created by
...
latex_documents = [
  ('index', 'nfelib.tex', u'nfelib Documentation',
...
man_pages = [
    ('index', 'nfelib', u'nfelib Documentation',
     [u'Dave Kuhlman'], 1)
]
...
#epub_tocdepth = 3
sys.path.append(os.path.abspath('../nfelib/v3_10'))
