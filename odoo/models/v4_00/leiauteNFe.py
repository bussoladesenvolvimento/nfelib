...
#
# Generated Tue Mar 20 01:43:43 2018 by generateDS.py(Akretion's branch).
...
CSTType31 = [
    ...
    ("60", u"60-Cobrado anteriormente por substituição tributária."),
]
...
# u"5-Operação presencial, fora do estabelecimento"
...
modFreteType = [
    ...
    ("1", (u"1- Contratação do Frete por conta do destinatário/remetente"
           u"(FOB)")),
...
# (u"Código do modelo do Documento Fiscal. Utilizar 01 para NF modelo 1/1A e"
# u"02 para NF modelo 02")
modType = [
    ("01", u"01"),
    ("02", u"02"),
]
...
class ICMS00(spec_models.AbstractSpecMixin):
    ...
    nfe_pFCP = fields.Monetary(
        ...
        help=(u"Percentual de ICMS relativo ao Fundo de Combate à Pobreza"
              u"(FCP)."))
    nfe_vFCP = fields.Monetary(
        digits=2, 
        string="Valor do ICMS relativo ao Fundo de Combate à Pobreza",
        help=u"Valor do ICMS relativo ao Fundo de Combate à Pobreza (FCP).")
...
class ICMS10(spec_models.AbstractSpecMixin):
    ...
    nfe_vBCFCP = fields.Monetary(
        ...
        help=u"Valor da Base de cálculo do FCP.")
    nfe_pFCP = fields.Monetary(
        digits=2, 
        string="Percentual de ICMS relativo ao Fundo de Combate à Pobreza",
        help=(u"Percentual de ICMS relativo ao Fundo de Combate à Pobreza"
    ...
    nfe_vBCFCPST = fields.Monetary(
        ...
        help=(u"Valor da Base de cálculo do FCP retido por substituicao"
              u"tributaria."))
    nfe_pFCPST = fields.Monetary(
        digits=2, 
        string="Percentual de FCP retido por substituição tributária",
        help=u"Percentual de FCP retido por substituição tributária.")
    nfe_vFCPST = fields.Monetary(
        digits=2, string="Valor do FCP retido por substituição tributária",
        help=u"Valor do FCP retido por substituição tributária.")
...
class ICMS60(spec_models.AbstractSpecMixin):
    ...
    nfe_pST = fields.Monetary(
        ...
        help=u"Aliquota suportada pelo consumidor final.")
    ...
    nfe_vBCFCPSTRet = fields.Monetary(
        ...
        help=u"Valor da Base de cálculo do FCP retido anteriormente por ST.")
    nfe_pFCPSTRet = fields.Monetary(
        digits=2, string="pFCPSTRet",
        help=(u"Percentual de FCP retido anteriormente por substituição"
              u"tributária."))
...
class ICMS70(spec_models.AbstractSpecMixin):
    ...
    nfe_vBCFCPST = fields.Monetary(
        digits=2, string="vBCFCPST",
        help=(u"Valor da Base de cálculo do FCP retido por substituição"
              u"tributária."))
    nfe_pFCPST = fields.Monetary(
        digits=2, 
        string="Percentual de FCP retido por substituição tributária",
...
class ICMSSN500(spec_models.AbstractSpecMixin):
    ...
    nfe_vBCFCPSTRet = fields.Monetary(
        ...
        help=u"Valor da Base de cálculo do FCP retido anteriormente.")
    nfe_pFCPSTRet = fields.Monetary(
        digits=2, string="pFCPSTRet",
        help=(u"Percentual de FCP retido anteriormente por substituição"
              u"tributária."))
...
class ICMSTot(spec_models.AbstractSpecMixin):
    ...
    nfe_vFCP = fields.Monetary(
        ...
        help=u"Valor Total do FCP (Fundo de Combate à Pobreza).")
    nfe_vBCST = fields.Monetary(
    ...
    nfe_vFCPST = fields.Monetary(
        digits=2, string="Valor Total do FCP", xsd_required=True,
        help=(u"Valor Total do FCP (Fundo de Combate à Pobreza) retido por"
              u"substituição tributária."))
    nfe_vFCPSTRet = fields.Monetary(
        digits=2, string="Valor Total do FCP",
        xsd_required=True,
        help=(u"Valor Total do FCP (Fundo de Combate à Pobreza) retido"
              u"anteriormente por substituição tributária."))
    ...
    nfe_vIPIDevol = fields.Monetary(
        ...
        xsd_required=True,
        help=(u"Valor Total do IPI devolvido. Deve ser informado quando"
              u"preenchido o Grupo Tributos Devolvidos na emissão de nota"
              u"finNFe=4 (devolução) nas operações com não contribuintes do"
              u"IPI. Corresponde ao total da soma dos campos id: UA04."))
...
class ICMSUFDest(spec_models.AbstractSpecMixin):
    ...
    nfe_vBCFCPUFDest = fields.Monetary(
        ...
        help=u"Valor da Base de Cálculo do FCP na UF do destinatário.")
...
class NFref(spec_models.AbstractSpecMixin):
    ...
    nfe_refNF = fields.Many2one(
        ...
        help=(u"Dados da NF modelo 1/1A referenciada ou NF modelo 2"
              u"referenciada"))
...
class comb(spec_models.AbstractSpecMixin):
    ...
    nfe_descANP = fields.Char(
        ...
        xsd_required=True,
        help=(u"Descrição do Produto conforme ANP. Utilizar a descrição de"
              u"produtos do Sistema de Informações de Movimentação de"
              u"Produtos - SIMP (http://www.anp.gov.br/simp/)."))
    nfe_pGLP = fields.Monetary(
        digits=2, 
        string="Percentual do GLP derivado do petróleo no produto GLP",
        help=(u"Percentual do GLP derivado do petróleo no produto GLP"
              u"(cProdANP=210203001). Informar em número decimal o"
              u"percentual do GLP derivado de petróleo no produto GLP."
              u"Valores 0 a 100."))
    nfe_pGNn = fields.Monetary(
        digits=2, string="Percentual de gás natural nacional",
        help=(u"Percentual de gás natural nacional - GLGNn para o produto GLP"
              u"(cProdANP=210203001). Informar em número decimal o"
              u"percentual do Gás Natural Nacional - GLGNn para o produto"
              u"GLP. Valores de 0 a 100."))
    nfe_pGNi = fields.Monetary(
        digits=2, 
        string="Percentual de gás natural importado GLGNi para o produto GLP",
        help=(u"Percentual de gás natural importado GLGNi para o produto GLP"
              u"(cProdANP=210203001). Informar em número deciaml o"
              u"percentual do Gás Natural Importado - GLGNi para o produto"
              u"GLP. Valores de 0 a 100."))
    nfe_vPart = fields.Monetary(
        digits=2, string="Valor de partida",
        help=(u"Valor de partida (cProdANP=210203001). Deve ser informado neste"
              u"campo o valor por quilograma sem ICMS."))
...
class detPag(spec_models.AbstractSpecMixin):
    _description = u"Grupo de detalhamento da forma de pagamento."
    _name = 'nfe.v3_10.detpag'
    ...
    nfe_vPag = fields.Monetary(
        digits=2, string="Valor do Pagamento",
        help=(u"Valor do Pagamento. Esta tag poderá ser omitida quando a tag"
              u"tPag=90 (Sem Pagamento), caso contrário deverá ser"
              u"preenchida."))
...
class infNFeSupl(spec_models.AbstractSpecMixin):
    ...
    nfe_urlChave = fields.Char(
        ...
        xsd_required=True,
        help=(u"Informar a URL da Consulta por chave de acesso da NFC-e. A"
              u"mesma URL que deve estar informada no DANFE NFC-e para"
              u"consulta por chave de acesso."))
...
class med(spec_models.AbstractSpecMixin):
    ...
    nfe_cProdANVISA = fields.Char(
        ...
        xsd_required=True,
        help=(u"Código de Produto da ANVISA. Utilizar o número do registro do"
              u"produto da Câmara de Regulação do Mercado de Medicamento –"
              u"CMED."))
...
class pag(spec_models.AbstractSpecMixin):
    ...
    nfe_detPag = fields.One2many(
        ...
        xsd_required=True,
        help=u"Grupo de detalhamento da forma de pagamento."
    )
    nfe_vTroco = fields.Monetary(
        digits=2, string="Valor do Troco.",
        help=u"Valor do Troco.")
...
class prod(spec_models.AbstractSpecMixin):
    ...
    nfe_CNPJFab = fields.Char(
        ...
        help=(u"CNPJ do Fabricante da Mercadoria, obrigatório para produto em"
              u"escala NÃO relevante."))
...
class rastro(spec_models.AbstractSpecMixin):
    ...
    nfe_nLote = fields.Char(
        ...
        xsd_required=True,
        help=u"Número do lote do produto.")
    nfe_qLote = fields.Monetary(
        digits=3, string="Quantidade de produto no lote.",
        xsd_required=True,
        help=u"Quantidade de produto no lote.")
    nfe_dFab = fields.Char(
        string="Data de fabricação/produção",
        xsd_required=True,
        help=u"Data de fabricação/produção. Formato AAAA-MM-DD.")
    nfe_dVal = fields.Char(
        string="Data de validade", xsd_required=True,
        help=(u"Data de validade. Informar o último dia do mês caso a validade"
              u"não especifique o dia. Formato AAAA-MM-DD."))
...
class refNF(spec_models.AbstractSpecMixin):
    _description = (u"Dados da NF modelo 1/1A referenciada ou NF modelo 2"
                    u"referenciada")
    ...
    nfe_mod = fields.Selection(
        ...
        help=(u"Código do modelo do Documento Fiscal. Utilizar 01 para NF"
              u"modelo 1/1A e 02 para NF modelo 02"))
    nfe_serie = fields.Char(
        string="Série do Documento Fiscal",
        xsd_required=True,
